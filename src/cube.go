...
func draw(surface *[100][100]float64, water *[100][100]float64, mode int, tours int, force int) {
	...
	for !window.ShouldClose() {
		if time.Since(lastTime) > 5000000 {
			...
			if (hauteur%1 == 0 && mode == 2) || (hauteur%1 == 0 && mode == 3 || (mode == 1 && hauteur%1 == 0)) {
				if goLeft == 1 {
					rotationZ += 3
				}
				if goRight == 1 {
...
func draw_water(surface *[100][100]float64, water *[100][100]float64, mode int) {
...
func draw_square_water(surface *[100][100]float64, water *[100][100]float64, kfloat float64, i int, j int, ifloat float32, jfloat float32, jfloatone float32, ifloatone float32) {
...
func drawScene(surface *[100][100]float64) {
